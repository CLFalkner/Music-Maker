...
void loop() {
  ...
  if (irrecv.decode(&results))                       // return 0 if no data ready, 1 if data ready
  {
    ...
    switch (results.value) {                           // which button is pressed
      case one:
        tone(speaker, octaves[octave, 0]);             // low B
        break;
      case two:
        tone(speaker, octaves[octave, 1]);             // C
        break;
      case three:
        tone(speaker, octaves[octave, 2]);             // D
        break;
      case four:
        tone(speaker, octaves[octave, 3]);             // E
        break;
      case five:
        tone(speaker, octaves[octave, 4]);             // F
        break;
      case six:
        tone(speaker, octaves[octave, 5]);             // G
        break;
      case seven:
        tone(speaker, octaves[octave, 6]);             // A
        break;
      case eight:
        tone(speaker, octaves[octave, 7]);             // high B
        break;
